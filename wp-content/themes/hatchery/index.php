...
<body id="home">
  ...
  <section class="homehero">
    ...
    <div class="homehero-video">
      <video autoplay muted loop src="<?php echo get_template_directory_uri(); ?>/assets/viedos/hatchery.mp4" poster="<?php echo get_template_directory_uri(); ?>/assets/images/video.jpg" class="homehero-video-source"></video>
    </div>
  </section>
